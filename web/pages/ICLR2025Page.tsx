 ...
 * ICLR2025Page
 *
 * Displays ICLR 2025 papers as a graph with embedding-based clustering.
 * - Loads paper metadata from /api/iclr/papers
 * - Loads similarity edges from /api/iclr/similarities
...
// Generate stable key for ICLR paper
